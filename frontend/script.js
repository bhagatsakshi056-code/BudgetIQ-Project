...
async function sendAiMessage() {
  ...
  msgs.innerHTML += `
    <div class="ai-msg user">
      ...
      <div class="ai-msg-bubble user-bubble"><p>${escapeHtml(message)}</p></div>
    </div>`;
  input.value = '';
  ...
  try {
    ...
    const data = await res.json();
    const reply = data.reply || data.msg || 'Sorry, I could not get a response.';

    document.getElementById(typingId)?.remove();
    msgs.innerHTML += `
      <div class="ai-msg ai">
        <div class="ai-msg-avatar">🤖</div>
        <div class="ai-msg-bubble"><p>${escapeHtml(reply)}</p></div>
      </div>`;
  } catch (err) {
    document.getElementById(typingId)?.remove();
    msgs.innerHTML += `
      <div class="ai-msg ai">
        <div class="ai-msg-avatar">🤖</div>
        <div class="ai-msg-bubble"><p>Sorry, I could not connect to the AI service right now.</p></div>
      </div>`;
  }
